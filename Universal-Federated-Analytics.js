  ...
  window.gas4 = function (a, b) {
    if (void 0 !== a && "" !== a && void 0 !== b && 'object' === typeof b) {
      ...
      if ("page_view" === a.toLowerCase())
        ...
        try {
          var e_n = ((/^(((email|telephone|image|cta|navigation|faq|accordion)_)?click|file_download|view_search_results|video_(start|pause|progress|complete|play)|official_USA_site_banner_click|form_(start|submit|progress)|content_view|social_share|error|sort|filter|was_this_helpful_submit|lcp|cls|inp|ttfb|fcp|performance.*)$/gi.test(a)) ? a : 'dap_event');
