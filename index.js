...
// import {onLCP, onINP, onCLS, onFID, onFCP, onTTFB} from './attribution';
// import {onLCP, onINP, onCLS, onFID, onFCP, onTTFB} from 'web-vitals/attribution';

/**
 * This file is part of the Digital Analytics
...
function _initWebvitals(){
  ...
  if(oCONFIG.WEBVITALS){
    import('web-vitals/attribution').then((attribution) => {
      /**
       * Adds listeners for web vitals events
       */
      attribution.onCLS(sendToGoogleAnalytics);
      attribution.onFID(sendToGoogleAnalytics);
      attribution.onLCP(sendToGoogleAnalytics);
      attribution.onFCP(sendToGoogleAnalytics);
      attribution.onTTFB(sendToGoogleAnalytics);
      attribution.onINP(sendToGoogleAnalytics);
    });
